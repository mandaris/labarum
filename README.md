...
![Basic Header of Labarum](media/labarum-icon.png)
...
### v1.3.18
  * Created `category.terms.html` and `categories-with-count.html` to better handle navigation of the archive and autogenerated category pages
  * Style changes to `list.html` and removed text
  * Added information to `theme.toml` to include some of the capability that the theme is able to do
